        ...
        <AnimatePresence>
            {open && (
                <motion.div
                    ...
                    className="absolute top-14 right-0 w-[400px] bg-[#071229] text-white rounded-2xl shadow-2xl border border-slate-800 z-[100] overflow-hidden flex flex-col"
                >
                    {/* Header */}
                    <div className="p-4 border-b border-slate-800 flex items-center justify-between bg-[#0b1a2a]">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button className="p-1.5 hover:bg-slate-800 rounded-lg transition-colors text-slate-400 cursor-pointer">
                    ...
                    {/* Content */}
                    <div className="flex-1 overflow-y-auto max-h-[450px] scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-start mb-0.5">
                                                    <h3 className={`text-sm font-bold truncate pr-6 ${
